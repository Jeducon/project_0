...
function recalc() {
  ...
  const uncheckedCount = [...items].filter(li => !li.querySelector('input[type="checkbox"]').checked).length
  total.textContent = 'Всього: ' + totalCount
  unchecked.textContent = 'Невідмічених: ' + uncheckedCount
  if (totalCount === 0) {
